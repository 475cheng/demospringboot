...
public final class StringUtil {
    ...
    /**
     * 判断是否是空集合 null和size==0 都返回 true
     *
     * @param list 判断的数组
     * @return 是否有效
     */
    public  static boolean isNullOrLengthZeroArray(Object[] list) {
     ...
     * @return 是否有效
     */
    public  static boolean isNullOrSizeZeroList(List list) {
    ...
    public  static String ltrim(String str1, int num) {
        String tt = "";
        if (!isNullOrEmpty(str1) && str1.length() >= num) {
    ...
    public  static String rtrim(String str, int num) {
        if (!isNullOrEmpty(str) && str.length() > num) {
    ...
    public  static boolean isIn(String substring, String[] source) {
        if(isNullOrEmpty(substring) || !CheckUtil.valid(source)){
            return false;
        }
        for (String t:source) {
