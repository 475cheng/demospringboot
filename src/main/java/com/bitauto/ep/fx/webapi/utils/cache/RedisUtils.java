package com.bitauto.ep.fx.webapi.utils.cache;
...
public class RedisUtils implements IRedisTemplateUtils {
    @Autowired
    ...
    public void hashAllPushHashMap(String key, Map<?, ?> value) {
        redisTemplate.opsForHash().putAll(key, value);
    }
    public String setGetSetValue(String key) {
